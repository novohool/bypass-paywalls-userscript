...
You can add it quick to tampermonkey via this link: [Add to Tampermonkey](https://github.com/novohool/bypass-paywalls-tampermonkey/raw/master/bypass-paywalls-tampermonkey.user.js)
